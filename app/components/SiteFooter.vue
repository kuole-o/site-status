  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink('https://www.imsyy.top/')"> IMSYY </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/kuole-o/site-status",
  home: "https://www.guole.fun",
  email: "mailto:guole.fun@qq.com",
};
</script>
